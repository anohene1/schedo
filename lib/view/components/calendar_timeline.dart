...
class _CalendarTimelineState extends State<CalendarTimeline> {
  ...
  SizedBox _buildDayList() {
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        padding: EdgeInsets.only(left: widget.leftMargin, right: 15),
          ...
          return Row(
            children: <Widget>[
              _DayItem(
                ...
                dayBackgroundColor: widget.dayBackgroundColor,
  ...
  Widget _buildYears() {
    ...
    final currentDate = _months[_monthSelectedIndex];
    final monthName = DateFormat.MMMM(_locale).format(currentDate);
    // final currentYear = _years[_yearSelectedIndex];
    ...
    return Row(
      ...
      children: [
        IconButton(onPressed: (){
          setState(() {
            _monthSelectedIndex--;
            _goToActualMonth(_monthSelectedIndex);
          });
        }, icon: Icon(Icons.chevron_left, size: 40,)),
        Text('$monthName ${currentDate.year}', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
        IconButton(onPressed: (){
          setState(() {
            _monthSelectedIndex++;
            _goToActualMonth(_monthSelectedIndex);
...
class _DayItem extends StatelessWidget {
  ...
  _buildDay(BuildContext context) {
    ...
    final selectedStyle = TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white);
      ...
      child: Container(
        decoration: isSelected
          ...
          borderRadius: BorderRadius.circular(16.0),
            ...
            : BoxDecoration(color: dayBackgroundColor ?? Colors.transparent, borderRadius: BorderRadius.circular(16.0)),
        height: height,
        width: width,
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              shortName,
              style: isSelected ? TextStyle(color: activeDayColor) : TextStyle(
